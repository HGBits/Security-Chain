# 🐛 Bug Bounty — rotina.sh

## 📌 Objetivo

Este projeto incentiva a identificação responsável de vulnerabilidades no script `rotina.sh`, com o objetivo de melhorar continuamente sua segurança, confiabilidade e robustez.
